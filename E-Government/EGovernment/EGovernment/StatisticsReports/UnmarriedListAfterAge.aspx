<%@ Page Title="الغير متزوجين بعد تجاوز عمر معين" Language="C#" MasterPageFile="~/SiteAdministration.Master" AutoEventWireup="true" CodeBehind="UnmarriedListAfterAge.aspx.cs" Inherits="EGovernment.StatisticsReports.UnmarriedNumAfterAge" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="control-group" style="font-family: 'Traditional Arabic'; font-size: x-large; ">
        ...
        <p>
            <div class="alert">
                <strong>
                    <h3 style="width: auto; direction: rtl;">قائمة بغير المتزوجين بعد تجاوز عمر معين</h3>
                </strong>
            </div>
        </p>
